...
var mongoose = require('mongoose'),
	...
	exports.municipios = function(req, res) {
		...
		if(req.query.nome == null && req.query.cod ==null && req.query.uf ==null){
		...
		//Case in that the parameter "cod" is different of null
		if (req.query.cod != null){
			Municipio.find({cod: req.query.cod }, funcaoRetorno);
		}
